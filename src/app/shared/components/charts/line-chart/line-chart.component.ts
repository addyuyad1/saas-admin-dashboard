...
export class SharedLineChartComponent implements AfterViewInit, OnChanges {
  ...
  private renderChart(): void {
    ...
    if (this.variant === 'area') {
      root
        .append('path')
        .datum(this.data)
        .attr('fill', 'rgba(31, 111, 235, 0.18)')
        .attr('d', area);
    }
